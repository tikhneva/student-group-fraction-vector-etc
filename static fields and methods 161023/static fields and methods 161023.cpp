...
/// <summary> 
/// add the variables we will use. We call the class УDateTimeФ because in it we will determine the date we need
/// </summary> 
class DateTime
{
private:
...
// перевантаженн€ дл€ cin >> date time
...
// перевантаженн€ дл€ cout << date time
...
/// <summary>
/// add the variables we will use. We call the class УStudentФ because in it we will describe student's personal information
/// </summary>
class Student
{
...
public:
    ...
    void RemoveStudentWithMinHomeworkAverage()
    {
        ...
        int lowestIndex = 0;
        double lowestAverage = students[0]->GetHometaskAverageRate(); // 7) теперь тут красивый вызов метода из класса —тудент :)
